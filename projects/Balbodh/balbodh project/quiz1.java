...
System.out.println("                                                                                          (CLASS -- X-A)");
        ...
        System.out.println("o=====>  The game cosists of 6 categories of questions!!\n"+
                           "o=====>  There are 5 questions in the first five categories and 15 questions in the last category i.e. Speed Round!!\n"+
    ...
    static Timer timer;
    public String quiz1(int seconds)throws IOException   // Timer Function
    {
        timer = new Timer();
